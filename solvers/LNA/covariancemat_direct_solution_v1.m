function CovMatSol=covariancemat_direct_solution_v1(CovMat0,detsolstruct,tspan,param,dimension)
...
CovMatSol=ode15s(@(t,CovMat) covariance_matrix_ode_v1(CovMat,detsolstruct,t,param,dimension),tspan,CovMat0);
