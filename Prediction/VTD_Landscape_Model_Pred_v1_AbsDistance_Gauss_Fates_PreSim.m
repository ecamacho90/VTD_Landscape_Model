function [simulations,fatesmatrix,errorcatched,paramcatched] = VTD_Landscape_Model_Pred_v1_AbsDistance_Gauss_Fates_PreSim(t0,dt,t1,times,samples,InitialCondition,nsimulations,paramsimulations,NoiseX,NoiseY,mutantstofit,nmutants,NumClust,Initial,OldData)
...
for mutantnumber = 1:nmutants
    ...
    simulations(:,:,1+nsimulations*(mutantnumber-1):nsimulations*mutantnumber) =...
        VTD_Landscape_Model_Pred_v1_AbsDistance_Gauss_Fates_EachMut(t0,dt,t1,InitialCondition,nsimulations,paramsimulations,NoiseX,NoiseY,mutantstofit(mutantnumber));
