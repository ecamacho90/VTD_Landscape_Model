...
%% For loop
function Parallel_function_VTD_AbsDist_ToCheck()
%%
...
for jobnum = 1%jobsvector
    ...
    Local_ABC_SMC_Algorithm_OLCM_VTD_landscape_v3_Gauss_AbsDistance(mutantstofit,parfitnumbers,EpT,T,Tmax,Nmax,Numberofparticleseachjob,PreviousData,namenewdata,CovarianceMatricesParticles,NoClassifiedOption,weightsdistances,streamnum,jobnum)
