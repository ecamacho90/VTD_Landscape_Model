...
for i = 1:9
    ...
    fprintf(fileID,['#PBS -o /cluster/',folder,'/ABCstdoutv',versionmodel,'v',versionsubmodel,'_00',num2str(i),'.txt \n']);
    fprintf(fileID,'\n');
    fprintf(fileID,'# redirect job?s standard error \n');
    fprintf(fileID,['#PBS -e /cluster/',folder,'/ABCstderrv',versionmodel,'v',versionsubmodel,'_00',num2str(i),'.txt \n']);
    fprintf(fileID,'\n');
    ...
    fprintf(fileID,'#PBS -M meritxell.saez@warwick.ac.uk \n');
    fprintf(fileID,'\n');
    fprintf(fileID,'# submit matlab job \n');
    fprintf(fileID,['matlab -nodisplay -r Parallel_function_VTD_AbsDist_Modelv',versionmodel,'_v',versionsubmodel,'_00',num2str(i),'>/cluster/',folder,'/ABClogv',versionmodel,'v',versionsubmodel,'_00',num2str(i),'.txt']);
...
for i = 10:40
    ...
    fprintf(fileID,'\n');
    fprintf(fileID,'# name the job \n');
    fprintf(fileID,['#PBS -N ABC','_v',versionmodel,'_v',versionsubmodel,'_',datefunc,'_0',num2str(i),' \n']);
    fprintf(fileID,'\n');
    fprintf(fileID,'# use the submission environment \n');
    fprintf(fileID,'#PBS -V \n');
    fprintf(fileID,'\n');
    fprintf(fileID,'# redirect job?s standard output \n');
    fprintf(fileID,['#PBS -o /cluster/',folder,'/ABCstdoutv',versionmodel,'v',versionsubmodel,'_0',num2str(i),'.txt \n']);
    fprintf(fileID,'\n');
    fprintf(fileID,'# redirect job?s standard error \n');
    fprintf(fileID,['#PBS -e /cluster/',folder,'/ABCstderrv',versionmodel,'v',versionsubmodel,'_0',num2str(i),'.txt \n']);
    fprintf(fileID,'\n');
    fprintf(fileID,'# maximum amount of real time that a job can be in the running state \n');
    fprintf(fileID,'#PBS -l walltime=100:00:00 \n');
    fprintf(fileID,'\n');
    ...
    fprintf(fileID,'\n');
    fprintf(fileID,'# submit matlab job \n');
    fprintf(fileID,['matlab -nodisplay -r Parallel_function_VTD_AbsDist_Modelv',versionmodel,'_v',versionsubmodel,'_0',num2str(i),'>/cluster/',folder,'/ABClogv',versionmodel,'v',versionsubmodel,'_0',num2str(i),'.txt']);
