function SetModelParam_Chir25FGF24
...
ModelParam.tMediaChanges = [ModelParam.t0;48;ModelParam.tF]; % Times at which there was a media change (time in hours), and the final time
